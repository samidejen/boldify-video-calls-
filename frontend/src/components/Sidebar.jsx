...
const Sidebar = () => {
  ...
  return (
    <aside className="w-44 bg-base-200 border-r border-base-300 hidden lg:flex flex-col h-screen sticky top-0">
...
export default Sidebar;import { Link, useLocation } from "react-router";
import useAuthUser from "../hooks/useAuthUser";
import {
  BellIcon,
  HomeIcon,
